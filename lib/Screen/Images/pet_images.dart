...
List<Color> petAwakeColors = [
  ...
  color["dark"], color["light"], color["light"], color["light"], color["light"], color["light"], color["light"], color["light"], color["medium"], color["medium"], color["medium"], color["light"], color["light"], color["light"], color["light"], color["light"], color["light"], color["light"], color["light"], color["light"], color["dark"],
  color["dark"], color["light"], color["light"], color["light"], color["light"], color["light"], color["light"], color["medium"], color["medium"], color["medium"], color["medium"], color["medium"], color["light"], color["light"], color["light"], color["light"], color["light"], color["light"], color["light"], color["light"], color["dark"],
  color["dark"], color["light"], color["light"], color["light"], color["light"], color["light"], color["medium"], color["medium"], color["medium"], color["medium"], color["medium"], color["medium"], color["medium"], color["light"], color["light"], color["light"], color["light"], color["light"], color["light"], color["light"], color["dark"],
  color["dark"], color["light"], color["light"], color["light"], color["light"], color["light"], color["dark"], color["dark"], color["medium"], color["medium"], color["medium"], color["dark"], color["dark"], color["light"], color["light"], color["light"], color["light"], color["light"], color["light"], color["light"], color["dark"],
  ...
  color["dark"], color["light"], color["light"], color["light"], color["light"], color["light"], color["light"], color["light"], color["light"], color["light"], color["light"], color["light"], color["light"], color["light"], color["light"], color["light"], color["dark"],
  color["dark"], color["light"], color["light"], color["light"], color["light"], color["light"], color["light"], color["light"], color["light"], color["light"], color["light"], color["light"], color["light"], color["light"], color["dark"],
  color["dark"], color["dark"], color["light"], color["light"], color["light"], color["light"], color["light"], color["light"], color["light"], color["light"], color["light"], color["dark"], color["dark"],
